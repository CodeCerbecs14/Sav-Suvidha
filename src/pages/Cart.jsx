    ...
    <div className='max-w-5xl mx-auto max-md:max-w-xl py-4'>
      ...
      <div className='grid md:grid-cols-3 gap-8 mt-12'>
        <div className='md:col-span-2 space-y-4'>
          {
            ...
            <h1>No ites available in Cart.</h1>
          )}
        </div>
        ...
        <div className='mt-5 flex gap-2'>
          <button disabled={cartItems.length === 0} className='disabled:opacity-60 text-sm px-4 py-3 bg-black text-white font-bold rounded-xl'>CheckOut</button>
          <button onClick={() => navigate('/home')} className='text-sm px-4 py-3 bg-black text-white font-bold rounded-xl'>Continue Shopping</button>
        </div>
        </div>
      </div>
    </div>
